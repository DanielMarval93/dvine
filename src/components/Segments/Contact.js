import {  Segment, Container, Divider, List, Grid, Image } from "semantic-ui-react";
import {
    FaInstagram,
    FaRegEnvelope,
    FaPhone,
            ...
            <Grid.Row>
              <Grid.Column width={4} centered style={{ textAlign: "center" }}>
                <List link  style={{ fontSize: "0.9em" }}>
                  <List.Item as="a" style={{ wordWrap: "break-word", color: "rgba(207, 160, 18, 1)" }}>
              ...
              <Grid.Column width={4} centered style={{ textAlign: "center" }}>
                <List link  style={{ fontSize: "0.9em"}}>
                  <List.Item as="a" style={{color: "rgba(207, 160, 18, 1)"}}  href="https://www.instagram.com/dvinemodels/">
              ...
              <Grid.Column width={4} centered style={{ textAlign: "center" }}>
                <List link  style={{ fontSize: "0.9em"}}>
                  <List.Item as="a" style={{color: "rgba(207, 160, 18, 1)"}}>
